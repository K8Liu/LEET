...
const fizzbuzzbazz = num => {
  const result = [];
  for (i = 1; i <= num; i++) {
    if (i % 3 === 0 && i % 5 === 0 && i % 7 === 0) result.push('fizzbuzzbazz');
    if (i % 5 === 0 && i % 7 === 0 && i % 3 !== 0) result.push('buzzbazz');
    if (i % 3 === 0 && i % 7 === 0 && i % 5 !== 0) result.push('fizzbazz');
    if (i % 5 === 0 && i % 3 === 0 && i % 7 !== 0) result.push('fizzbuzz');
    if (i % 7 === 0 && i % 3 !== 0 && i % 5 !== 0) result.push('bazz');
    if (i % 5 === 0 && i % 3 !== 0 && i % 7 !== 0) result.push('buzz');
    if (i % 3 === 0 && i % 5 !== 0 && i % 7 !== 0) result.push('fizz');
    if (i % 3 !== 0 && i % 5 !== 0 && i % 7 !== 0) result.push(i);
  }
  return result;
};
